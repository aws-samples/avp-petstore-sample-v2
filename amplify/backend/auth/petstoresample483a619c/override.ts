import { AmplifyAuthCognitoStackTemplate, AmplifyUserPoolGroupStackTemplate, AmplifyProjectInfo } from '@aws-amplify/cli-extensibility-helper';
...
export function override(resources: AmplifyAuthCognitoStackTemplate, amplifyProjectInfo: AmplifyProjectInfo) {
    ...
    resources.userPool.schema = [
        ...
        userTypeAttribute, storeOwnerAttr, employmentStoreCode, franchiseCode
    ]
